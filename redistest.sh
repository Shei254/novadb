...
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/bitfield"
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/cas"
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/hmcas"
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/increx"
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/setnxex"
runOne "tclsh tests/test_helper.tcl --single novadb_ssd_test/zscanbyscore"
