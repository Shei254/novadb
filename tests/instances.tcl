...
proc spawn_instance {type base_port count {conf {}}} {
    for {set j 0} {$j < $count} {incr j} {
        ...
        set cfgfile [file join $dirname novadbplus.conf]
        set cfg [open $cfgfile w]
        set pidfile $dirname/novadbplus.pid
        puts $cfg "port $port"
