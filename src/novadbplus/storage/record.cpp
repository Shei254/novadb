...
RecordValue::RecordValue(double v, RecordType type)
  : _type(type),
    ...
    _cas(-1),
    _pieceSize(-1) {
  auto d = ::novadbplus::doubleEncode(v);
...
RecordType RecordValue::getEleType() const {
  ...
  switch (_type) {
    case novadbplus::RecordType::RT_KV:
      return RecordType::RT_DATA_META;

    case novadbplus::RecordType::RT_LIST_META:
      return RecordType::RT_LIST_ELE;

    case novadbplus::RecordType::RT_HASH_META:
      return RecordType::RT_HASH_ELE;

    case novadbplus::RecordType::RT_ZSET_META:
      return RecordType::RT_ZSET_H_ELE;

    case novadbplus::RecordType::RT_SET_META:
      return RecordType::RT_SET_ELE;

    case novadbplus::RecordType::RT_TBITMAP_META:
      return RecordType::RT_TBITMAP_ELE;
