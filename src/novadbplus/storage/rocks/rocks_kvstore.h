...
#ifndef SRC_novadbPLUS_STORAGE_ROCKS_ROCKS_KVSTORE_H_
#define SRC_novadbPLUS_STORAGE_ROCKS_ROCKS_KVSTORE_H_
...
#endif  // SRC_novadbPLUS_STORAGE_ROCKS_ROCKS_KVSTORE_H_
