...
#ifndef SRC_novadbPLUS_UTILS_SCOPEGUARD_H_
#define SRC_novadbPLUS_UTILS_SCOPEGUARD_H_
...
#define LOKI_ON_BLOCK_EXIT                                 \
  ::Loki::ScopeGuard LOKI_ANONYMOUS_VARIABLE(scopeGuard) = \
    ::novadbplus::MakeGuard
#define LOKI_ON_BLOCK_EXIT_OBJ                             \
  ::Loki::ScopeGuard LOKI_ANONYMOUS_VARIABLE(scopeGuard) = \
    ::novadbplus::MakeObjGuard

#endif  // SRC_novadbPLUS_UTILS_SCOPEGUARD_H_
