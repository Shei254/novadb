...
#ifndef SRC_novadbPLUS_UTILS_SYNC_POINT_H_
#define SRC_novadbPLUS_UTILS_SYNC_POINT_H_
...
#define TEST_SYNC_POINT(x) novadbplus::SyncPoint::GetInstance()->Process(x)
#define TEST_SYNC_POINT_CALLBACK(x, y) \
  novadbplus::SyncPoint::GetInstance()->Process(x, y)
#endif  // WITH_SYNC_POINT

#endif  // SRC_novadbPLUS_UTILS_SYNC_POINT_H_
