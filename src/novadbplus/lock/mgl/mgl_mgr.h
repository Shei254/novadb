...
#ifndef SRC_novadbPLUS_LOCK_MGL_MGL_MGR_H__
#define SRC_novadbPLUS_LOCK_MGL_MGL_MGR_H__
...
// warning C4316: novadbplus::mgl::MGLockMgr
class MGLockMgr {
 public:
  MGLockMgr() = default;
  void lock(MGLock* core);
...
#endif  // SRC_novadbPLUS_LOCK_MGL_MGL_MGR_H__
