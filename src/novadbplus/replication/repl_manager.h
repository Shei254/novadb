...
#ifndef SRC_novadbPLUS_REPLICATION_REPL_MANAGER_H_
#define SRC_novadbPLUS_REPLICATION_REPL_MANAGER_H_
...
#include "novadbplus/replication/repl_util.h"
...
#endif  // SRC_novadbPLUS_REPLICATION_REPL_MANAGER_H_
