...
#ifndef SRC_novadbPLUS_NETWORK_BLOCKING_TCP_CLIENT_H_
#define SRC_novadbPLUS_NETWORK_BLOCKING_TCP_CLIENT_H_
...
#endif  // SRC_novadbPLUS_NETWORK_BLOCKING_TCP_CLIENT_H_
